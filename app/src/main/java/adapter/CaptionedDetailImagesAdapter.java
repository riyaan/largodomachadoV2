 ...
 */
public class CaptionedDetailImagesAdapter extends RecyclerView.Adapter<CaptionedDetailImagesAdapter.ViewHolder>{
    ...
    // TODO: Refactor
    public CaptionedDetailImagesAdapter(String[] captions, int[] imageIds, List<String> imageShortWriteups)
    {
    ...
    @Override
    public CaptionedDetailImagesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(CaptionedDetailImagesAdapter.ViewHolder holder, final int position) {
