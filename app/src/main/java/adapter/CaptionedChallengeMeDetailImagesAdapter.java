 ...
 */
public class CaptionedChallengeMeDetailImagesAdapter extends RecyclerView.
        Adapter<CaptionedChallengeMeDetailImagesAdapter.ViewHolder>{
    ...
    // TODO: Refactor
    public CaptionedChallengeMeDetailImagesAdapter(String[] captions, int[] imageIds,
                                                   List<String> imageShortWriteups)
    {
    ...
    @Override
    public CaptionedChallengeMeDetailImagesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                                 int viewType) {
        this.context = parent.getContext();

        CardView cv = (CardView)LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_challengeme_detail, parent, false);
        return new ViewHolder(cv);
    }

    @Override
    public void onBindViewHolder(CaptionedChallengeMeDetailImagesAdapter.ViewHolder holder,
                                 final int position) {
